...
TEST(PlaneTestSuite, NormalOfAPlaneIsConstantEverywhere){
    Plane p;
    Tuple n1 = p.normal_at(Tuple::point(0, 0, 0));
    Tuple n2 = p.normal_at(Tuple::point(10, 0, -10));
    Tuple n3 = p.normal_at(Tuple::point(-5, 0, 150));
    EXPECT_EQ(n1, Tuple::vector(0, 1, 0));
    EXPECT_EQ(n2, Tuple::vector(0, 1, 0));
    EXPECT_EQ(n3, Tuple::vector(0, 1, 0));
}

TEST(PlaneTestSuite, RayIsParallelToPlane){
    Plane p;
...
TEST(PlaneTestSuite, RayIsCoplanarToPlane){
    Plane p;
